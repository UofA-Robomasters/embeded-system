...
#define STICK_TO_PITCH_ANGLE_INC_FACT       0.002f
...
extern ChassisSpeed_Ref_t HeroSpeedRef;  //hero arm
//extern ChassisSpeed_Ref_t HeroTrackRef;  //hero track
extern Gimbal_Ref_t HeroTrackRef;  //hero track
