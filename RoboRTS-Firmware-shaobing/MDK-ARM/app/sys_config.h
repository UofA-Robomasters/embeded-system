...
/**************************shot  setting********************************/
/* shot speed */
#define DEFAULT_FRIC_WHEEL_SPEED 2000 //maximum value is 2500  //used to 1150
/* shot frequence */
...
#else
  /* chassis motor use 3508 */  // using 3510 instead
  /* the deceleration ratio of chassis motor */
  #define CHASSIS_DECELE_RATIO (1.0f/19.0f)
  /* single 3508 motor maximum speed, unit is rpm */
  #define MAX_WHEEL_RPM        8371  //8347rpm = 3500mm/s    //used to set it as 8500
  /* chassis maximum translation speed, unit is mm/s */
  #define MAX_CHASSIS_VX_SPEED 3300  //8000rpm
  #define MAX_CHASSIS_VY_SPEED 3300
  /* chassis maximum rotation speed, unit is degree/s */
  #define MAX_CHASSIS_VR_SPEED 150   //5000rpm  // used to set as 300
#endif
...
/* gimbal relevant */
#define PIT_ANGLE_MAX        10//15
#define PIT_ANGLE_MIN        -10//-20
#define YAW_ANGLE_MAX       	25 //50
#define YAW_ANGLE_MIN        -25 //-50
