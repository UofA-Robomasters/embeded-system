...
void get_infantry_info(void)
{
  ...
  pc_send_mesg.chassis_information.gyro_palstance = gim.sensor.yaw_palstance; // used to set it as chassis.gyro_palstance
  pc_send_mesg.chassis_information.gyro_angle     = chassis.gyro_angle;       // used to set it as chassis.gyro_angle
...
/*custom message send to pc*/
	//pc_send_mesg.student_custom_data.data[0] = glb_ctrl_mode;
	pc_send_mesg.student_custom_data.data[1] = gim.ctrl_mode;
	pc_send_mesg.student_custom_data.data[2] = chassis.ctrl_mode;
...
void get_custom_data_info(void)
{
  //memcpy(&pc_rece_mesg.pc_to_server_data, &student_to_judgesys_data, sizeof(user_to_server_t));
	pc_rece_mesg.show_in_client_data.data1 =1; 
	pc_rece_mesg.show_in_client_data.data2 =2; 
	pc_rece_mesg.show_in_client_data.data3 =3;
}
